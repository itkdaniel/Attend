            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                dbr.child("History").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Log.d("uid_user", "grouplist size: " + eventListGroup.size() + " " + "userlist size: " + eventListUser.size());
                        for(int i = 0; i < eventListGroup.size(); i++) {
                            ...
                            try {
                                ...
                                Toast.makeText(mContext, "No Events to show", Toast.LENGTH_LONG).show();
                                Log.d("uid_user", "Failed");
                                // display textview
                            }
//
